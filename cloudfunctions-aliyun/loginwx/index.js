...
const loginConfig = {
  AppId: 'wx418e91a689e0b4c2', //微信小程序AppId
  AppSecret: '2f38dbe0cf201d59cd6435b5c3fd2832' //微信小程序AppSecret
};

const passSecret = 'xue'; //用于用户数据库密码加密的密钥，使用一个比较长的随机字符串即可
...
async function login(event) {
  let data = {
    appid: loginConfig$1.AppId,
    secret: loginConfig$1.AppSecret,
    js_code: event.code,
